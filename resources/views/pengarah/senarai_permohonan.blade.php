...
<div class="modern-container">
    ...
    <div class="search-container">
        <form method="GET" action="{{ route('pengarah.senarai-permohonan') }}" style="display: flex; gap: 0.5rem; width: 100%;">
            <div class="search-input-wrapper">
                ...
                @if(request('search'))
                    <a href="{{ route('pengarah.senarai-permohonan') }}" 
                ...
                <tbody id="tableBody">
                    @foreach($permohonans as $permohonan)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('pengarah.permohonan.edit', $permohonan->id_permohonan) }}" class="action-btn">
                                    Semak
                                </a>
                            </td>
                        </tr>
