...
<div class="modern-container">
    ...
    <div class="search-container">
        <form method="GET" action="{{ route('pegawai.permohonan.lama') }}" style="display: flex; gap: 0.5rem; width: 100%;">
            <div class="search-input-wrapper">
                ...
                @if(request('search'))
                    <a href="{{ route('pegawai.permohonan.lama') }}" 
        ...
        <table class="modern-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-date="{{ $permohonan->tarikh_ulasan_pegawai ? $permohonan->tarikh_ulasan_pegawai->format('Y-m-d') : '0000-00-00' }}">
                        {{ $permohonan->tarikh_ulasan_pegawai ? $permohonan->tarikh_ulasan_pegawai->format('d/m/Y') : 'N/A' }}
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('pegawai.permohonan.show', $permohonan->id_permohonan) }}" 
...
<script>
    ...
    function sortTable(columnIndex, type) {
        ...
        rows.sort((a, b) => {
            ...
            if (type === 'id') {
                aValue = a.cells[columnIndex].getAttribute('data-id') || '';
                bValue = b.cells[columnIndex].getAttribute('data-id') || '';
            } else if (type === 'text') {
