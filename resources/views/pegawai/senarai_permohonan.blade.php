...
<div class="modern-container">
    <div class="page-header">
        ...
        <form action="{{ route('pegawai.senarai-permohonan') }}" method="GET" style="display: flex; gap: 0.5rem; align-items: center; flex: 1;">
            <div class="search-input-wrapper">
                ...
                @if(request('search'))
                    <a href="{{ route('pegawai.senarai-permohonan') }}" 
                ...
                <tbody id="tableBody">
                    @foreach($permohonans as $permohonan)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('pegawai.permohonan.edit', $permohonan->id_permohonan) }}" class="action-btn">
                                    Semak
                                </a>
                            </td>
                        </tr>
