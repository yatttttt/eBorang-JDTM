...
<body>
    <div class="modern-container">
        ...
        <div class="button-group">
            <a href="{{ route('pentadbir_sistem.permohonan.lama') }}" class="action-btn">
                <i class="fas fa-arrow-left"></i>
                Kembali
            </a>
            @if($permohonan->fail_borang)
                <a href="{{ route('pentadbir_sistem.permohonan.download', $permohonan->id_permohonan) }}" class="action-btn btn-primary">
