...
<div class="modern-container">
    ...
    <div class="search-container">
        <form method="GET" action="{{ route('pentadbir_sistem.permohonan.lama') }}" style="display: flex; gap: 0.5rem; width: 100%;">
            <div class="search-input-wrapper">
                ...
                @if(request('search'))
                    <a href="{{ route('pentadbir_sistem.permohonan.lama') }}" 
        ...
        <table class="modern-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-date="{{ $permohonan->tarikh_ulasan_pentadbir_sistem ? $permohonan->tarikh_ulasan_pentadbir_sistem->format('Y-m-d') : '0000-00-00' }}">
                        {{ $permohonan->tarikh_ulasan_pentadbir_sistem ? $permohonan->tarikh_ulasan_pentadbir_sistem->format('d/m/Y') : 'N/A' }}
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('pentadbir_sistem.permohonan.show', $permohonan->id_permohonan) }}" 
