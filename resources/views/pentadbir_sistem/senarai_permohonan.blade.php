...
<div class="modern-container">
    ...
    <div class="search-container">
        <form method="GET" action="{{ route('pentadbir_sistem.senarai-permohonan') }}" style="display: flex; gap: 0.5rem; width: 100%;">
            <div class="search-input-wrapper">
                ...
                @if(request('search'))
                    <a href="{{ route('pentadbir_sistem.senarai-permohonan') }}" 
        ...
        <table class="modern-table">
            <thead>
                <tr>
                    ...
                    <th>Kategori</th>
                    <th class="sortable" onclick="sortTable(3, 'date')" data-sort="none">Tarikh Permohonan</th>
                    <th>Tindakan</th>
                </tr>
            </thead>
            <tbody id="tableBody">
                @foreach($permohonans as $permohonan)
                    <tr>
                        ...
                        <td data-kategori="{{ $permohonan->formatted_kategori }}">
                            {{ $permohonan->formatted_kategori }}
                        </td>
                        ...
                        <td>
                            <a href="{{ route('pentadbir_sistem.permohonan.edit', $permohonan->id_permohonan) }}" class="action-btn">
                                Semak
                            </a>
                        </td>
                    </tr>
        ...
        rows.sort((a, b) => {
            ...
            if (type === 'id') {
                ...
                if (columnIndex === 1) {
                    ...
                    aValue = (a.cells[columnIndex].getAttribute('data-kategori') || '').toLowerCase();
                    bValue = (b.cells[columnIndex].getAttribute('data-kategori') || '').toLowerCase();
                }
            } else if (type === 'date') {
