...
<style>
   ...
   .action-btn {
    ...
    /* ✅ FIXED MODAL STYLES - Always centered in viewport */
    .modal-overlay {
        display: none;
...
<div class="modern-container">
    ...
    <div class="search-container">
        <form method="GET" action="{{ route('admin.senarai_permohonan_lama') }}" style="display: flex; gap: 0.5rem; width: 100%;">
            <div class="search-input-wrapper">
                ...
                @if(request('search'))
                    <a href="{{ route('admin.senarai_permohonan_lama') }}" 
        ...
        <table class="modern-table">
            <thead>
                <tr>
                    ...
                    <th>Kategori</th>
                    <th class="sortable" onclick="sortTable(3, 'date')" data-sort="none">Tarikh hantar</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $permohonan->formatted_kategori }}</td>
                     <td data-date="{{ $permohonan->tarikh_hantar ? $permohonan->tarikh_hantar->format('Y-m-d') : '0000-00-00' }}">
                        {{ $permohonan->tarikh_hantar ? $permohonan->tarikh_hantar->format('d/m/Y') : 'N/A' }}
                    </td>
                    <td data-date="{{ $permohonan->tarikh_maklumat_akses ? $permohonan->tarikh_maklumat_akses->format('Y-m-d') : '0000-00-00' }}">
                   ...
                   <td>
                        <div class="action-buttons">
                            <a href="{{ route('admin.senarai_permohonan_lama_view', $permohonan->id_permohonan) }}" 
                            class="action-btn action-btn-view"
                            title="Lihat Lebih Lanjut">
                                <i class="fas fa-eye"></i>
                            </a>
                            
                            <a href="{{ route('admin.permohonan.pdf', $permohonan->id_permohonan) }}" 
                           ...
                           <button onclick="confirmDelete(
                            ...
                            '{{ $permohonan->nama_pemohon }}', 
                            '{{ $permohonan->formatted_kategori ?? 'Tiada' }}'
                            )"  
...
{{-- ✅ CRITICAL: Modal placed OUTSIDE .modern-container for proper viewport positioning --}}
<div class="modal-overlay" id="deleteModal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p>Adakah anda pasti mahu memadam permohonan ini? Tindakan ini tidak boleh dibatalkan.</p>
            <div class="modal-user-info">
                <p><strong>ID Permohonan:</strong> <span id="deletePermohonanId"></span></p>
                <p><strong>Nama Pemohon:</strong> <span id="deletePermohonanNama"></span></p>
                <p><strong>Kategori:</strong> <span id="deletePermohonanKategori"></span></p>
            </div>
        </div>
...
<script>
    ...
    /**
     * ✅ FIXED: Function to open modal and lock body scroll
     */
    function confirmDelete(permohonanId, namaPemohon, kategori) {
        const modal = document.getElementById('deleteModal');
        const form = document.getElementById('deleteForm');
        const idSpan = document.getElementById('deletePermohonanId');
        const namaSpan = document.getElementById('deletePermohonanNama');
        const kategoriSpan = document.getElementById('deletePermohonanKategori');
        
        if (modal && form && idSpan && namaSpan && kategoriSpan) {
            // Set data in modal
            idSpan.textContent = permohonanId;
            namaSpan.textContent = namaPemohon;
            kategoriSpan.textContent = kategori;
            
            // Set form action URL
            form.action = `/admin/permohonan-lama/${permohonanId}`;
    ...
    /**
     * ✅ FIXED: Function to close modal and unlock body scroll
     */
